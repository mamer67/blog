...
class PostController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to access 'index' and 'view' actions.
				'actions'=>array('index','view','upload','uploadz'),
				'users'=>array('*'),
			),
	...
	public function actionUploadz()
	{
        ...
        $uploader = new qqFileUploader($allowedExtensions, $sizeLimit, true);
	...
	public function actionUpload(){
		...
		echo '<input type="radio" name="a" value=1 >red';
		//var_dump($_FILES);
	}
	/**
